<?php
    ...
    */
    class StrongBox_Service_Process extends Phpfox_Service 
    {
        ...
        public function getStrongFeed()
        {
            $sSelect = 'feed.*,sb.comment_id,sb.type_id_sb,' . Phpfox::getUserField();
            ...
            ->join(Phpfox::getT('strongbox_feed'), 'sb', 'sb.feed_id = feed.feed_id')
            ->where('sb.user_id_sb='.Phpfox::getUserId())
            ->order($sOrder)
            ->group('feed.feed_id')         
