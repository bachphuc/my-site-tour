...
<script type="text/javascript">
    {if $sView == 'private' || $sView == 'my' || $bMyPost}
...
<div class="sub_section_menu" id="private_menu">
    <ul>
        <li {if $sView == 'my' || $bMyPost}class="active"{/if}><a style="background-image: url({param var='core.path'}module/privatepost/static/image/my_post.png);" href="{url link=$aUser.user_name view='my'}">{phrase var='privatepost.my_post'}</a></li>
