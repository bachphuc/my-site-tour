	...
	public function getActions()
	{
		...
		return array(
			'dislike' => array(
				...
				'item_type_id' => 'waytame', // used internally to differentiate between photo albums and photos for example.
				'item_phrase' => Phpfox::getPhrase('waytame.item_phrase'), // used to display to the user what kind of item is this
