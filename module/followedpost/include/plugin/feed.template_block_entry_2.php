<?php
    ...
    */
    ...
    ?>
    <?php if ($iFollow > 0) {?>
        <li class="follow_number">
            <p style="color: #63799F">Followed by <label><?php echo $iFollow;?></label> wayter<?php if($iFollow > 1) { echo 's'; } ?></p>
        </li>
        <li class="follow_line"><span>|</span></li>
        <?php }else{ ?>
        <li class="follow_number" style="display: none;">
            <p style="color: #63799F">Followed by <label>0</label> wayters</p>
        </li>
        <li class="follow_line" style="display: none;"><span >|</span></li>
        <?php } ?>
