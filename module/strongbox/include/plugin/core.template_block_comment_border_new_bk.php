<?php
    if(Phpfox::isModule('strongbox'))
    {
        ...
        parentUL.append(\'<li id="icon_showmarkbox_\'+idComment+\'" style=" display: block;"><div style="cursor: pointer;" class="show_strong_box js_hover_title"><span class="js_hover_info">'.Phpfox::getPhrase('strongbox.remove_strong_box').'</span><img src="'.$path.'module/strongbox/static/image/strongbox_yellow.png" alt="" id="button_image_strongbox" class="img_button" onclick="$.ajaxCall(\\\'strongbox.makePublicBoxIcon\\\',\\\'id=\'+idComment+\'&type=0\\\', \\\'GET\\\')"></div></li>\');
        parentUL.append(\'<li id="icon_markbox_\'+idComment+\'" style=" display: none;"><div style="cursor: pointer;" class="show_strong_box js_hover_title"><span class="js_hover_info">'.Phpfox::getPhrase('strongbox.strong_box').'</span><img src="'.$path.'module/strongbox/static/image/strongbox.png" alt="" id="button_image_strongbox" class="img_button" onclick="$.ajaxCall(\\\'strongbox.makeStrongBoxIcon\\\',\\\'feed='.$feed_id.'&id=\'+idComment+\'&type=0\\\', \\\'GET\\\')"></div></li>\');
        }
        else
        {
        if(parentUL.find(".show_strong_box").length > 0){
        parentUL.find(".show_strong_box").remove();}
        parentUL.append(\'<li id="icon_markbox_\'+idComment+\'" style=" display: block;"><div style="cursor: pointer;" class="show_strong_box js_hover_title"><span class="js_hover_info">'.Phpfox::getPhrase('strongbox.strong_box').'</span><img src="'.$path.'module/strongbox/static/image/strongbox.png" alt="" id="button_image_strongbox" class="img_button" onclick="$.ajaxCall(\\\'strongbox.makeStrongBoxIcon\\\',\\\'feed='.$feed_id.'&id=\'+idComment+\'&type=0\\\', \\\'GET\\\')"></div></li>\');
        parentUL.append(\'<li id="icon_showmarkbox_\'+idComment+\'" style=" display: none;"><div style="cursor: pointer;" class="show_strong_box js_hover_title"><span class="js_hover_info">'.Phpfox::getPhrase('strongbox.remove_strong_box').'</span><img src="'.$path.'module/strongbox/static/image/strongbox_yellow.png" alt="" id="button_image_strongbox" class="img_button" onclick="$.ajaxCall(\\\'strongbox.makePublicBoxIcon\\\',\\\'id=\'+idComment+\'&type=0\\\', \\\'GET\\\')"></div></li>\');
        }
        }
        }
        }
