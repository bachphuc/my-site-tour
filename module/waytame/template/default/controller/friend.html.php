...
{php}
    if(Phpfox::getLib('request')->get('view') == 'expire')
    {
        $this->_aVars['aFriends'] = Phpfox::getService('waytame')->getExpireFriendQuestionToday();
    }
    Phpfox::getService('waytame')->processFriends($this->_aVars['aFriends']);
{/php}
