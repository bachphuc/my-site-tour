...
<style type="text/css">
    .waytame_action_link a{l}
    font-weight:bold;
    {r}
    .form_answer .show_name{l}
    display:none;
    {r}
    .comment_mini{l}
    color:#3b5998;
            ...
            <div class="js_feed_comment_border">
                ...
                <div class="comment_mini_content_holder">    
                    ...
                    <div id="answer_panel" class="comment_mini_content_border">
                        <div class="js_comment_like_holder">
                            <div>                        
                                        ...
                                        <div class="comment_mini_content_border">                      
                                            <div class="js_comment_like_holder">        
                                                ...
                                                <div class="activity_like_holder comment_mini">
                                                    <span class="waytame_total_like">{$aQuestion.total_like}</span> 
                                                    {*}<img class="v_middle" alt="" src="{param var='core.path'}theme/frontend/default/style/default/image/layout/like.png">{*} like this ·                                                    
                                                    <span class="waytame_total_dislike">{$aQuestion.total_dislike}</span> 
                                                    {*}<img class="v_middle" alt="" src="http://localhost/snowfox/snowfox.3.7.7/theme/frontend/default/style/default/image/layout/dislike.png">{*} dislike this</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
